# Seperate dev packages for ubuntu.sh file
# Files are intended to work together or seperate including WSL
# Tools do not have to be on the same server to communicate
