...
3. Him: "How can I **see what he/she sees?**" (This is not misplaced). Who visited for bulloon helium (started electronics, ended aisle B52) Synology should have this documentation, first few months (heat map, sticker, check fb post)? [(1)](https://ophelialabs.github.io/jb./tutorial-1/#loading-the-neural-data), [(2)](https://ophelialabs.github.io/jb./stack/#augmented-intent), [(3)](https://ophelialabs.github.io/jb./stack/#syglass-the-lens)
     ...
     * At first I thought Russian Spy (whats so special about her) and even still. ... **My Queen**: I kneeled and said "Because I Drink", but what I am supposed to really say? Note the underlined misspell under kneeled. Although in all fairness, that is a Queen Bee. Who did I come to when I wanted to share excitement? What is the difference? Minute discrepancies? Now flip the coin. 
...
8. Him: "[Trying to do our job for us](#)" . "**[Hand it off to me](https://www.syglass.io/academy/v/tracing-basics-fn2tc)**" (Research papers?)
