...
I don't care what anyone says, no one is this good at making things up. This is personal. Who needs to make things up when you are telling the truth?
...
I believe you should build <wiki:Markdown> [documentation](https://mystmd.org/guide/quickstart) (for structure) [beforehand](https://docs.copilotkit.ai/ms-agent-python/quickstart) (webhooks). This repository is a collaborative enterprise asset. It is not static; it is a living system that should be improved continuously by the people who use it. Participation is encouraged across engineering, operations, research, and leadership teams to ensure knowledge remains accurate and broadly useful.
