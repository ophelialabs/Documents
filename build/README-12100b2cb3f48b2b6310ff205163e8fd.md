...
- **Sensing vs. Actuation**: While the goal is restoring senses, the same "write" capability (stimulating 100,000 neurons) could theoretically be used to modulate mood, influence decision-making, or induce specific emotional states without the user’s awareness. [(1)](https://www.science.org/doi/suppl/10.1126/science.adn0623/suppl_file/science.adn0623_sm.pdf)
